...
function registerPatient() {
    ...
    for (let i = 0; i < inputData.length; i++) {
        ...
        if (inputData[i] != 'IdProof' && inputData[i] != 'weight' && inputData[i] != 'RelativeName' && inputData[i] != 'RelativeName' && (document.getElementById(inputData[i]).value == null || document.getElementById(inputData[i]).value == '' )) {
            new Noty({
                theme: 'relax',
